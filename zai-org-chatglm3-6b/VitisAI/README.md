...
|:--------------------------------------------------|:----------------------------------|
| `zai-org/chatglm3-6b`                | `chatglm3-6b_quark_vitisai_llm.json`  |
...
```bash
cd olive-recipes/zai-org-chatglm3-6b/VitisAI
...
```bash
# chatglm3-6b
olive run --config chatglm3-6b_quark_vitisai_llm.json
```

✅ Optimized model saved in: `models/chatglm3-6b-vai/`
